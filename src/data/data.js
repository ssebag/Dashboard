import { iconsImgs } from "../img/img";

export const navigationLinks = [
    { id: 1, title: 'Home', image: iconsImgs.home , link: '/'},
    { id: 2, title: 'Budget', image: iconsImgs.budget , link: '/budget'},
    { id: 3, title: 'Transactions', image: iconsImgs.plane , link: '/transactions'},
    { id: 4, title: 'Subscriptions', image: iconsImgs.wallet , link: '/subscriptions'},
    { id: 5, title: 'Loans', image: iconsImgs.bills , link: '/loans'},
